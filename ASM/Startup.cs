...
namespace ASM
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IDanhMuc,DanhMucSvc>();
            services.AddTransient<IDonHang,DonhangSvc>();
            services.AddTransient<IDonHangChiTiet, DonHangChiTietSvc>();
            services.AddTransient<IMonAn, MonanSvc>();
            services.AddTransient<IGioHang, GiohangSvc>();
